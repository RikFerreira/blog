...
**Mind the file size!** You may not be able to directly open this file in your memory. The computer used to run this code has 16 gigabytes of RAM. Consider using SQL databases if you have trouble^[Also consider to remake the function `read_microdata`. It isn't the most efficient code in the universe.].
